...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<AddressProvider>().setMapLocation(widget.lat, widget.long);
      context.read<AddressProvider>().setAddressDataForEdit(
        label: widget.label,
        name: widget.name,
        phone: widget.phone,
        email: widget.email,
        kotaKecamatan: widget.kotaKecamatan,
                  ...
                  AlamatkuButton(
                    ...
                    onPressed: () async {
                      if (_formKey.currentState?.validate() ?? false) {
                        try {
                          await addressProvider.updateAddressData(
                            widget.id,
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              ...
                              content: Text('Update Address Success'),
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              ...
                              content: Text('Update Address failed'),
                            ),
                          );
                        }
                      }
